						...
						<div class="mainSlider" data-thumb="true" data-thumb-width="230" data-thumb-height="100">
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<!-- Slides -->
									<div class="swiper-slide" data-thumb="resources/images/slider/slide-02-thumb.png" data-href="http://google.com" data-target="_blank">
										<!-- _blank or _self ( _self is default )-->
										<div class="wrapper">
											<figure><img src="resources/images/slider/slide-02.jpg" alt=""></figure>
									...
									<div class="swiper-slide" data-thumb="resources/images/slider/slide-01-thumb.png">
										<div class="wrapper">
											<figure><img src="resources/images/slider/slide-01.jpg" alt=""></figure>
									...
									<div class="swiper-slide" data-thumb="resources/images/slider/slide-03-thumb.png">
										<div class="wrapper">
											<figure><img src="resources/images/slider/slide-03.jpg" alt=""></figure>
									...
									<div class="swiper-slide" data-thumb="resources/images/slider/slide-04-thumb.png">
										<div class="wrapper">
											<figure><img src="resources/images/slider/slide-04.jpg" alt=""></figure>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery-main">
													<a href="#"><img class="product-image-photo" src="resources/images/products/product-16-c1.jpg" alt=""></a>
												...
												<ul class="color-swatch hidden-xs">
													<li class="active">
														<a data-image="resources/images/products/product-16-c1.jpg" href="#"><img src="resources/images/colorswatch/color-blue.png" alt="Blue"></a>
													</li>
													<li>
														<a data-image="resources/images/products/product-16-c2.jpg" href="#"><img src="resources/images/colorswatch/color-grey.png" alt="Gray"></a>
													</li>
													<li>
														<a data-image="resources/images/products/product-16-c3.jpg" href="#"><img src="resources/images/colorswatch/color-red.png" alt="Red"></a>
													</li>
													<li>
														<a data-image="resources/images/products/product-16-c4.jpg" href="#"><img src="resources/images/colorswatch/color-violet.png" alt="Violet"></a>
													</li>
													<li>
														<a data-image="resources/images/products/product-16-c5.jpg" href="#"><img src="resources/images/colorswatch/color-green.png" alt="Green"></a>
													</li>
												</ul>
                                            </div>
											<!-- /Product Photo -->
												...
												<div class="carousel-inside slide" data-ride="carousel">
													<div class="carousel-inner" role="listbox">
														<div class="item active">
															<a href="#"><img class="product-image-photo" src="resources/images/products/product-20.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img class="product-image-photo" src="resources/images/products/product-20-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img class="product-image-photo" src="resources/images/products/product-20-2.jpg" alt=""></a>
														</div>
													</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="#"><img class="product-image-photo" src="resources/images/products/product-26.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="#"><img src="resources/images/products/product-26.jpg" data-image="resources/images/products/product-26.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-26-1.jpg" data-image="resources/images/products/product-26-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-26-2.jpg" data-image="resources/images/products/product-26-2.jpg" alt=""></a>
														</div>
													</div>
									...
									<div class="product-item-inside">
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<!-- product main photo -->
												<div class="product-item-gallery-main">
													<a href="#"><img class="product-image-photo" src="resources/images/products/product-25.jpg" alt=""></a>
													<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
												</div>
												<!-- /product main photo  -->
												<div class="countdown-box hidden-xs">
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="#"><img src="resources/images/products/product-25.jpg" data-image="resources/images/products/product-25.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-25-1.jpg" data-image="resources/images/products/product-25-1.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="#"><img class="product-image-photo" src="resources/images/products/product-18.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="#"><img src="resources/images/products/product-18.jpg" data-image="resources/images/products/product-18.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-18-1.jpg" data-image="resources/images/products/product-18-1.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="#"><img class="product-image-photo" src="resources/images/products/product-10.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
									...
									<div class="product-item-inside">
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<!-- product main photo -->
												<div class="product-item-gallery-main">
													<a href="#"><img class="product-image-photo" src="resources/images/products/product-17.jpg" alt=""></a>
													<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
												...
												<div class="product-item-gallery-previews-wrapper">
													<div class="product-item-gallery-previews">
														<div class="item">
															<a href="#"><img src="resources/images/products/product-17.jpg" data-image="resources/images/products/product-17.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-17-1.jpg" data-image="resources/images/products/product-17-1.jpg" alt=""></a>
														</div>
														<div class="item">
															<a href="#"><img src="resources/images/products/product-17-2.jpg" data-image="resources/images/products/product-17-2.jpg" alt=""></a>
														</div>
													</div>
													<div class="carousel-arrows"></div>
												</div>
										...
										<div class="product-item-info">
											...
											<div class="product-item-photo">
												...
												<div class="product-item-gallery">
													<!-- product main photo -->
													<div class="product-item-gallery-main">
														<a href="#"><img class="product-image-photo" src="resources/images/products/product-27.jpg" alt=""></a>
														<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
													</div>
													<!-- /product main photo  -->
												</div>
							...
							<div class="col-md-7">
								<a href="#" class="banner-wrap">
									<div class="banner style-17 autosize-text image-hover-scale" data-fontratio="4.6">
										<img src="resources/images/banners/banner-17.jpg" alt="Banner">
								...
								<a href="#bannerLink" class="banner-wrap">
									<div class="banner style-18 autosize-text image-hover-scale" data-fontratio="4.6">
										<img src="resources/images/banners/banner-18.jpg" alt="Banner">
							...
							<div class="col-md-5">
								<a href="#bannerLink" class="banner-wrap">
									<div class="banner style-19 autosize-text image-hover-scale" data-fontratio="4.6">
										<img src="resources/images/banners/banner-19.jpg" alt="Banner">
										<div class="banner-caption vertb horl">
											<div class="vert-wrapper">
												<div class="vert">
								...
								<a href="#bannerLink" class="banner-wrap">
									<div class="banner style-20 autosize-text image-hover-scale" data-fontratio="4.6">
										<img src="resources/images/banners/banner-20.jpg" alt="Banner">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="blog-carousel">
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="resources/images/blog/blog-1.jpg" alt="From Blog"> </a>
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="resources/images/blog/blog-2.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="resources/images/blog/blog-3.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
									...
									<!-- Blog Carousel Item -->
									<div class="blog-item">
										<a href="blog.html" class="blog-item-photo"> <img class="product-image-photo" src="resources/images/blog/blog-4.jpg" alt="From Blog"> </a>
										<div class="blog-item-info">
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src="resources/images/products/product-19.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Label -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-19.jpg" data-image="resources/images/products/product-19.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-19-1.jpg" data-image="resources/images/products/product-19-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-19-2.jpg" data-image="resources/images/products/product-19-2.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-19-3.jpg" data-image="resources/images/products/product-19-3.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
														...
														<ul class="color-swatch hidden-xs">
															<li class="active">
																<a data-image="resources/images/products/product-19.jpg" href="#"><img src="resources/images/colorswatch/color-yellow.png" alt="Yellow"></a>
															</li>
															<li>
																<a data-image="resources/images/products/product-19-c1.jpg" href="#"><img src="resources/images/colorswatch/color-blue.png" alt="Blue"></a>
															</li>
															<li>
																<a data-image="resources/images/products/product-19-c2.jpg" href="#"><img src="resources/images/colorswatch/color-red.png" alt="Red"></a>
															</li>
															<li>
																<a data-image="resources/images/products/product-19-c3.jpg" href="#"><img src="resources/images/colorswatch/color-grey.png" alt="Grey"></a>
															</li>
															<li>
																<a data-image="resources/images/products/product-19-c4.jpg" href="#"><img src="resources/images/colorswatch/color-green.png" alt="Green"></a>
															</li>
															<li>
																<a data-image="resources/images/products/product-19-c5.jpg" href="#"><img src="resources/images/colorswatch/color-violet.png" alt="Violet"></a>
															</li>
														</ul>
													</div>
													<!-- /Product Photo -->
												...
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<div class="product-item-gallery">
															<!-- product main photo -->
															<div class="product-item-gallery-main">
																<a href="#"><img class="product-image-photo" src="resources/images/products/product-13.jpg" alt=""></a>
																<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
															</div>
															<!-- /product main photo  -->
														</div>
											...
											<div class="product-item-inside">
												<div class="product-item-info">
													...
													<div class="product-item-photo">
														...
														<!-- product main photo -->
														<div class="product-item-gallery-main">
															<a href="#"><img class="product-image-photo" src="resources/images/products/product-11-1.jpg" alt=""></a>
															<a href="quick-view.html" title="Quick View" class="quick-view-link quick-view-btn"> <i class="icon icon-eye"></i><span>Quick View</span></a>
														</div>
														<!-- /product main photo  -->
														<!-- Product Actions -->
														...
														<div class="product-item-gallery-previews-wrapper">
															<div class="product-item-gallery-previews">
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-11.jpg" data-image="resources/images/products/product-11.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-11-1.jpg" data-image="resources/images/products/product-11-1.jpg" alt=""></a>
																</div>
																<div class="item">
																	<a href="#"><img src="resources/images/products/product-11-2.jpg" data-image="resources/images/products/product-11-2.jpg" alt=""></a>
																</div>
															</div>
															<div class="carousel-arrows"></div>
														</div>
						...
						<div class="row">
							<div class="col-md-6 col-lg-8">
								<div class="image-banner text-center">
									<a href="#"> <img src="resources/images/banners/footer-banner.jpg" alt="Footer Banner" class="img-responsive"> </a>
								</div>
							</div>
							<div class=" col-md-6 col-lg-4">
								<div class="footer-copyright text-center"> Â© 2016 Demo Store. All Rights Reserved. </div>
								<div class="footer-payment-link text-center">
									<a href="#"><img src="resources/images/payment-logo/icon-pay-1.png" alt=""></a>
									<a href="#"><img src="resources/images/payment-logo/icon-pay-2.png" alt=""></a>
									<a href="#"><img src="resources/images/payment-logo/icon-pay-3.png" alt=""></a>
									<a href="#"><img src="resources/images/payment-logo/icon-pay-4.png" alt=""></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="productstack-content">
			<div class="products-list-wrapper">
				<ul class="products-list">
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-10.jpg" alt=""></a> <span class="item-qty">3</span>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-11.jpg" alt=""></a> <span class="item-qty">3</span>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-12.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-13.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-14.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
					...
					<li>
						<a href="product.html" title="Product Name Long Name"><img class="product-image-photo" src="resources/images/products/product-15.jpg" alt=""></a> <span class="item-qty">3</span>
						<div class="actions"> <a class="action edit" href="#" title="Edit item"><i class="icon icon-pencil"></i></a> <a class="action delete" href="#" title="Delete item"><i class="icon icon-trash-alt"></i></a>
							<div class="edit-qty">
								<input type="number" value="3">
								<button type="button" class="btn">Apply</button>
